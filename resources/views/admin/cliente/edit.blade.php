	...
	<div class="row">
		<div class="panel panel-default">
		  <div class="panel-body">
		    ...
		    <form class="form-horizontal" action="{{ route('cliente.update',['id' => $cli->id ]) }}" autocomplete="off" method="POST">
		      {{ csrf_field() }}
			 ...
			 @endphp
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      ...
			      value="{{ old('lastname', $cli->lastname) }}">
			    </div>
			  </div>
			      	...
			      	<!-- Fill the select per separate because i need to simulate the selection of one -->
			      		@foreach($gender as $i => $g)
			      			<!-- 
			      			 ...
			      			 -->
							<option value="{{ $i }}" 
							{{ $i == old('gender',$cli->gender) ? 'selected="selected"' : ''}}>
								{{ $g }}</option>
			      		@endforeach
					</select>
			    </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      ...
			      value="{{ old('phoneNumber',$cli->phoneNumber) }}">
			    </div>
			  </div>
